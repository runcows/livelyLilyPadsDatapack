...
execute unless score item_removed lily_pad_range matches 1 if data storage rc_lilypads:item {candle_count:"2"} run data modify entity @e[tag=lilyPadItem,limit=1,sort=nearest] Item.count set value 2
execute unless score item_removed lily_pad_range matches 1 if data storage rc_lilypads:item {candle_count:"3"} run data modify entity @e[tag=lilyPadItem,limit=1,sort=nearest] Item.count set value 3
execute unless score item_removed lily_pad_range matches 1 if data storage rc_lilypads:item {candle_count:"4"} run data modify entity @e[tag=lilyPadItem,limit=1,sort=nearest] Item.count set value 4
