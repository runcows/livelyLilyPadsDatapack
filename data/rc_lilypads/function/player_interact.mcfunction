# store selected item
data modify storage rc_lilypads:item selected set value ""
...
execute if data storage rc_lilypads:item {selected:"minecraft:spore_blossom"} unless entity @e[type=minecraft:block_display,tag=lilyPadLight,distance=..0.2] unless score soundSpore lily_pad_range matches 1 store success score soundSpore lily_pad_range run summon minecraft:block_display ~ ~ ~ {Tags:["lilyPadLight","lilyPadLight3"],block_state:{Name:"minecraft:spore_blossom"},transformation:{translation:[0.25f,0.74f,0.75f],left_rotation:[0.707f,0f,0f,0.707f],scale:[0.5f,0.5f,0.7f],right_rotation:[0.707f,0f,0f,0.707f]}}
    ...
    # cactus flower
execute if data storage rc_lilypads:item {selected:"minecraft:cactus_flower"} unless entity @e[type=minecraft:block_display,tag=lilyPadLight,distance=..0.2] unless score soundCactus lily_pad_range matches 1 store success score soundCactus lily_pad_range run summon minecraft:block_display ~ ~ ~ {Tags:["lilyPadLight"],block_state:{Name:"minecraft:cactus_flower"},transformation:{translation:[0.1f,0.02f,0.1f],left_rotation:[0f,0f,0f,1f],scale:[0.8f,0.8f,0.8f],right_rotation:[0f,0f,0f,1f]}}
...
execute if score soundCactus lily_pad_range matches 1 run playsound minecraft:block.cactus_flower.place block @a[distance=..10] ~.5 ~.1 ~.5
...
scoreboard players reset soundCactus lily_pad_range
